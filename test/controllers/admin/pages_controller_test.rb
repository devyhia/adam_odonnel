...
class Admin::PagesControllerTest < ActionController::TestCase
  ...
  test "should create admin_page" do
    assert_difference('Admin::Page.count') do
      post :create, admin_page: { content: @admin_page.content, link: @admin_page.link, title: @admin_page.title }
    end
  ...
  test "should update admin_page" do
    patch :update, id: @admin_page, admin_page: { content: @admin_page.content, link: @admin_page.link, title: @admin_page.title }
    assert_redirected_to admin_page_path(assigns(:admin_page))
  end
