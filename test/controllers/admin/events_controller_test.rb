...
class Admin::EventsControllerTest < ActionController::TestCase
  ...
  test "should create admin_event" do
    assert_difference('Admin::Event.count') do
      post :create, admin_event: { image: @admin_event.image, what: @admin_event.what, what_more: @admin_event.what_more, when: @admin_event.when }
    end
  ...
  test "should update admin_event" do
    patch :update, id: @admin_event, admin_event: { image: @admin_event.image, what: @admin_event.what, what_more: @admin_event.what_more, when: @admin_event.when }
    assert_redirected_to admin_event_path(assigns(:admin_event))
  end
